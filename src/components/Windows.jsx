...
const Windows = ({ showAbout = false, showHistory = false, showContact = false, showSkills = false }) => {
  ...
  const albumImages = [
    `${process.env.PUBLIC_URL}/assets/blackkeys.jpg`,
    `${process.env.PUBLIC_URL}/assets/grimes.jpg`,
    `${process.env.PUBLIC_URL}/assets/radiohead.jpg`,
    `${process.env.PUBLIC_URL}/assets/Abbey-Road.webp`,
    `${process.env.PUBLIC_URL}/assets/Elton-John-Goodbye-Yellow-Brick-Road-album-cover-820.webp`,
    `${process.env.PUBLIC_URL}/assets/Nirvana-Bleach.jpg`,
    `${process.env.PUBLIC_URL}/assets/clairocharm.jpg`,
    `${process.env.PUBLIC_URL}/assets/CHRIS-STAPLETON-HIGHER.jpg`,
    `${process.env.PUBLIC_URL}/assets/mcr.jpg`,
    `${process.env.PUBLIC_URL}/assets/billie.jpg`,
  ]; // Album artwork URLs

  const trackUrls = [
    `${process.env.PUBLIC_URL}/assets/audio/The-Black-Keys-Weight-of-Love.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/Grimes-Oblivion.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/Radiohead-Just.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/wmggw.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/Goodbye-Yellow-Brick-Road.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/AboutAGirl.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/Clairo-Nomad.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/ChrisStapleton-TheBottom.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/MCR-HouseofWolves.mp3`,
    `${process.env.PUBLIC_URL}/assets/audio/BillieEilish-LAMOURDEMAVIE.mp3`,
